...
export class HttpAdapter extends Adapter {
   ...
   * @return {Promise}
   */
  createMany(mapper, props, opts: any = {}) {
    opts.params = this.getParams(opts);
    opts.params = this.queryTransform(mapper, opts.params, opts);
    opts.suffix = this.getSuffix(mapper, opts);
    return super.createMany(mapper, props, opts);
  }
   ...
   */
  deserialize(mapper, response, opts: any = {}) {
   ...
   * @return {Promise}
   */
  findAll(mapper, query: any = {}, opts: any = {}) {
    opts.params = this.getParams(opts);
    opts.suffix = this.getSuffix(mapper, opts);
    utils.deepMixIn(opts.params, query);
    opts.params = this.queryTransform(mapper, opts.params, opts);
   ...
   */
  getEndpoint(mapper, id, opts: any = {}) {
   ...
   * @param {object} opts Configuration options.
   */
  getPath(method, mapper, id, opts: any = {}) {
    const args = [
    ...
    return utils.resolve(this.beforeHTTP(config, opts))
      .then((_config) => {
        ...
        if (hasFetch && (this.useFetch || opts.useFetch || !this.http)) {
          return this.fetch(config).then(logResponse, logResponse);
        }
   ...
   * @return {Promise}
   */
  POST(url, data, config: any = {}, opts: any = {}) {
    let op;
    config.url = url || config.url;
   ...
   * @return {Promise}
   */
  PUT(url, data, config: any = {}, opts: any = {}) {
    let op;
    config.url = url || config.url;
    config.data = data || config.data;
   ...
   */
  queryTransform(mapper, params, opts: any = {}) {
   ...
   */
  serialize(mapper, data, opts: any = {}) {
  ...
  sum(mapper, field, query: any = {}, opts: any = {}) {
    ...
    utils.deepMixIn(opts.params, query);
    opts.params = this.queryTransform(mapper, opts.params, opts);
    return super.sum(mapper, field, query, opts);
  }
   ...
   * @return {Promise}
   */
  update(mapper, id, props, opts: any = {}) {
    opts.params = this.getParams(opts);
    opts.params = this.queryTransform(mapper, opts.params, opts);
    opts.suffix = this.getSuffix(mapper, opts);
   ...
   * @return {Promise}
   */
  updateAll(mapper, props, query: any = {}, opts: any = {}) {
    opts.params = this.getParams(opts);
    utils.deepMixIn(opts.params, query);
    opts.params = this.queryTransform(mapper, opts.params, opts);
    opts.suffix = this.getSuffix(mapper, opts);
...
export function addAction(name, opts) {
  ...
  return function (mapper) {
    ...
    mapper[name] = function (id, _opts) {
      ...
      const adapter = this.getAdapter(_opts.adapter || this.defaultAdapter || 'http');
      const config: any = {};
 ...
 * decorate when invoked.
 */
export function addActions(opts: any = {}) {
  return function (mapper) {
    utils.forOwn(opts, (value, key) => {
